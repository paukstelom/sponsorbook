...
async def get_organization(
    organization_id: str, database: DatabaseDep
) -> Organization:
...
async def delete_organization(database: DatabaseDep, organization_id: str) -> None:
...
async def create_organization(
    database: DatabaseDep, body: CreateOrganizationModel = Body()
):
